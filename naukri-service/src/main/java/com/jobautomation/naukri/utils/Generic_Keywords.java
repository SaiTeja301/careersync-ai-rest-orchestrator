package com.jobautomation.naukri.utils;
...
/**
 * Generic Selenium keyword library — low-level browser interaction helpers.
 * Adapted from monolith's Generic_Keywords.java.
 *
 * Package migration: com.jobbot.utils → com.jobautomation.naukri.utils
 * Change: RateLimiter.microDelay() replaces raw Thread.sleep in scrollIntoView.
 */
